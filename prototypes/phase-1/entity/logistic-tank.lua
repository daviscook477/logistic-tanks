...
local logistic_storage_tank_buffer = fns.make_logistic_storage_tank("buffer", logistic_tanks.tint_logistic_storage_tank_buffer)
...
-- Allow copy/paste requests between requester/buffer tanks using the on_entity_settings_pasted event
logistic_storage_tank_buffer[2].additional_pastable_entities = logistic_tanks.copy_paste_names
logistic_storage_tank_requester[2].additional_pastable_entities = logistic_tanks.copy_paste_names

data:extend(logistic_storage_tank_requester)
data:extend(logistic_storage_tank_buffer)
