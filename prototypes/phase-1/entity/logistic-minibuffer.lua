...
local logistic_minibuffer_buffer = fns.make_logistic_minibuffer("buffer", logistic_tanks.tint_logistic_storage_tank_buffer)
...
-- Allow copy/paste requests between requester/buffer minibuffers using the on_entity_settings_pasted event
logistic_minibuffer_buffer[1].additional_pastable_entities = logistic_tanks.copy_paste_names
logistic_minibuffer_requester[1].additional_pastable_entities = logistic_tanks.copy_paste_names

data:extend(logistic_minibuffer_buffer)
